...
in summery by this repo we relize how dll injection works using Kiwi module in Powershell Empire (this project is no longer supported) and mimikatz in Metasploit for credential steal.
### Install LAB 
